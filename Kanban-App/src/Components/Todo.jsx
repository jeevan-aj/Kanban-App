...
export const TodoItem = styled.div`
  ...
  margin-bottom: 8px;
  background-color: ${props => (props.isDragging? 'lightgreen; transition: background-color 2s linear;' :  'white; transition: background-color 0.5s linear;')};
  padding: 8px;
`;
            ...
            <Draggable key={cur.id} draggableId={cur.id.toString()} index={idx}>
              {(provided) => (
                ...
                >
                  ...
                  <div className="pt-1 bg-slate-600">
